                          ...
                          {/* Left column — text */}
                                  <div className="space-y-6">
                                              <div className="inline-flex items-center gap-2 bg-[#0F1F3D] text-white text-xs font-medium px-3 py-1.5 rounded-full">
                                                            <span className="w-1.5 h-1.5 bg-green-400 rounded-full animate-pulse"></span>span>
                                              ...
                                              <h1 className="text-4xl sm:text-5xl font-extrabold text-[#0F172A] leading-tight">
                                                            ...
                                                            <span className="text-[#1D4ED8]">industrial metal 3D printing.</span>span>
                                              </h1>h1>
                                              ...
                                              <div className="bg-[#ECFDF5] border border-[#059669]/20 rounded-lg p-4 flex items-start gap-3">
                                                            ...
                                                            <div>
                                                                            <p className="text-sm font-semibold text-[#059669]">Your designs stay under your control</p>p>
                                                ...
                                                {/* Card header */}
                                                            <div className="bg-[#FFF7ED] border-b border-[#E2E8F0] px-5 py-3 flex items-center justify-between">
                                                                            <div className="flex items-center gap-2">
                                                                                              <span className="text-[#EA580C] text-xs font-medium">⚠ Prototype marketplace data — illustrative only</span>span>
                                                                            </div>div>
                                                                            <span className="text-xs text-[#64748B]">Demo Request</span>span>
                                                            </div>div>
                                                ...
                                                {/* Part details */}
                                                            <div className="px-5 pt-4 pb-3 border-b border-[#E2E8F0]">
                                                                            <div className="flex items-start justify-between">
                                                                                              <div>
                                                                                                                  <h3 className="font-bold text-[#0F172A]">Titanium Structural Bracket</h3>h3>
                                                                                                                  <p className="text-xs text-[#64748B] mt-0.5">Ti6Al4V · 50 units · DMLS or LPBF · ±0.05mm</p>p>
                                                                                                </div>div>
                                                                                              <span className="bg-[#0F1F3D] text-white text-xs px-2 py-1 rounded-md font-medium">Restricted</span>span>
                                                                            </div>div>
                                                                            <div className="flex gap-2 mt-2">
                                                                                              <span className="text-xs bg-[#EFF6FF] text-[#1D4ED8] px-2 py-0.5 rounded-full">ISO 9001</span>span>
                                                                                              <span className="text-xs bg-[#EFF6FF] text-[#1D4ED8] px-2 py-0.5 rounded-full">Heat Treatment</span>span>
                                                                                              <span className="text-xs bg-[#EFF6FF] text-[#1D4ED8] px-2 py-0.5 rounded-full">CNC Finishing</span>span>
                                                                            </div>div>
                                                            </div>div>
                              ...
                              <div
                                ...
                                {supplier.recommended && (
                                                                          <div className="flex items-center gap-1 mb-1.5">
                                                                                                  ...
                                                                                                  <span className="text-xs font-semibold text-[#1D4ED8]">Recommended technical fit</span>span>
                                                                          </div>div>
                                                  )}
                                                  <div className="flex items-center justify-between">
                                                                        <div>
                                                                                                <p className="text-sm font-bold text-[#0F172A]">{supplier.name}</p>p>
                                                                                                <p className="text-xs text-[#64748B]">{supplier.location} · {supplier.technology}</p>p>
                                                                        </div>div>
                                                                        <div className="text-right">
                                                                                                <p className="text-sm font-bold text-[#0F172A]">{supplier.price}</p>p>
                                                                                                <p className="text-xs text-[#64748B]">{supplier.leadTime}</p>p>
                                                                        </div>div>
                                                  </div>div>
                                                  <div className="flex items-center gap-3 mt-1.5 text-xs text-[#64748B]">
                                                                        <span>Score: <strong className="text-[#0F172A]">{supplier.score}</strong>strong></span>span>
                                                                        <span>{supplier.certification}</span>span>
                                                    {supplier.nda && (
                                                            ...
                                                            <div className="px-5 py-3 border-t border-[#E2E8F0]">
                                                                            <p className="text-xs text-center text-[#64748B] italic">Fictional supplier data for demonstration purposes only</p>p>
                                                            </div>div>
                                              
                                                            <div className="px-5 py-3 border-t border-[#E2E8F0] bg-[#F8FAFC] flex items-center justify-between">
                                                                            <div className="flex items-center gap-2 text-xs text-[#64748B]">
                                                                                              <span className="w-2 h-2 bg-[#059669] rounded-full"></span>span>
                                                                                              Matched in 3 days
                                                                            </div>div>
                                                                            <span className="text-xs text-[#64748B]">Average response time</span>span>
                                                            </div>div>
                                              </div>div>
                                  </div>div>
                        </div>div>
